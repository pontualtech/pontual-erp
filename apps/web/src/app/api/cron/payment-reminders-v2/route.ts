...
// Wave AE-2C: dispatcher real em lib separada (evita OOM no build do
...
// Wave AE-2C: wrapper local que injeta o gate. emitReminderReal (lib)
// despacha de fato; este wrapper mantém a assinatura antiga + flag.
async function emitReminder(args: {
  ...
  return emitReminderReal({ ...args, real_dispatch_enabled: REAL_DISPATCH_ENABLED })
}
