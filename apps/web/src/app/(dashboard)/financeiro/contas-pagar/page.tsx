        ...
        <table className="w-full text-sm">
          ...
          <tbody className="divide-y">
            {loading ? (
              ...
              <tr><td colSpan={5} className="px-4 py-8 text-center text-gray-400">Nenhuma conta a pagar encontrada</td></tr>
            ) : (
              contas.map(c => {
                ...
                return (
                  <tr key={c.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-4 py-3 text-gray-500">{c.supplier_name || '—'}</td>
