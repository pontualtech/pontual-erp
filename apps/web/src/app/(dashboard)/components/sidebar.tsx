...
export function Sidebar({ user }: { user: AuthUser }) {
  ...
  const content = (
    <div className="flex h-full flex-col">
      ...
      <div className="flex h-14 items-center border-b px-4">
        <span className="text-lg font-bold text-blue-700">PontualERP</span>
      </div>
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          'fixed inset-y-0 left-0 z-40 w-60 border-r bg-white transition-transform lg:static lg:translate-x-0',
