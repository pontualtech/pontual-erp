            ...
            <>
              ...
              <div className="text-center mb-6">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                  {otpChannel === 'whatsapp'
                    ? `Código enviado via WhatsApp para ${otpData?.phone_hint || 'seu número'}`
                    : `Código enviado para ${otpData?.email_hint || 'seu email'}`}
                </p>
              </div>
              ...
              <form onSubmit={handleVerifyOtp} className="space-y-5">
                ...
                <div className="text-center">
                  {otpTimer > 0 ? (
                    ...
                    <p className="text-sm text-red-600 dark:text-red-400 font-medium">Código expirado</p>
                  )}
                </div>
                ...
                <form onSubmit={handleWhatsAppLogin} className="space-y-4">
                  <div>
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400 mt-1.5">
                      Enviaremos um código pelo WhatsApp para você entrar
                    </p>
                  </div>
