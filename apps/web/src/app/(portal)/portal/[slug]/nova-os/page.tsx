...
export default function PortalNovaOSPage() {
  ...
  // Fase 4 conformidade Meta: opt-in de marketing no WhatsApp (default desmarcado).
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      const res = await fetch('/api/portal/os', {
        ...
        body: JSON.stringify({ ...form, accept_marketing: acceptMarketing }),
      })
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-zinc-950">
      ...
      <main className="max-w-2xl mx-auto px-4 py-6">
        ...
        <form onSubmit={handleSubmit} className="bg-white dark:bg-zinc-900 rounded-xl border border-gray-200 dark:border-zinc-700 p-6 space-y-5">
          ...
          {/* Fase 4 conformidade Meta: opt-in de marketing WhatsApp (desmarcado por padrão) */}
          <div className="flex items-start gap-2.5">
            <input
              ...
              className="mt-0.5 h-4 w-4 rounded border-gray-300 dark:border-zinc-600 text-blue-600 focus:ring-blue-500"
            />
            <label htmlFor="accept_marketing" className="text-sm text-gray-600 dark:text-gray-400">
              Aceito receber novidades, dicas e ofertas no WhatsApp. Você pode cancelar quando quiser respondendo <strong>SAIR</strong>.
            </label>
          </div>
