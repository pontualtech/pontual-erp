  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-zinc-950">
      ...
      <main className="max-w-5xl mx-auto px-4 py-6">
        ...
        {/* Tirar duvida — caminho recomendado (passa pela IA primeiro,
            escala pra atendente se nao resolver, fica registrado em ticket
            que aparece no painel do operador). Feature 2026-05-12 passo 8/9. */}
        <div className="bg-gradient-to-br from-emerald-50 to-blue-50 dark:from-emerald-950/40 dark:to-blue-950/40 rounded-xl border border-emerald-200 dark:border-emerald-900 p-5 mb-4" data-print-hide>
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1 min-w-0">
              <h2 className="font-semibold text-gray-900 dark:text-gray-100 mb-1">
                Tem dúvida sobre esta OS?
              </h2>
              <p className="text-sm text-gray-600 dark:text-gray-400 mb-3">
                Nossa assistente virtual responde em segundos. Se precisar falar com um atendente, basta clicar.
              </p>
              <button
                type="button"
                onClick={() => router.push(`/portal/${slug}/suporte-ia?os=${osId}&intent=duvida`)}
                className="inline-flex items-center gap-2 py-2.5 px-5 bg-emerald-600 dark:bg-emerald-500 hover:bg-emerald-700 text-white font-medium rounded-xl transition-colors"
              >
