      ...
      <div className="w-full max-w-md">
        <div className="bg-white dark:bg-zinc-900 rounded-2xl shadow-xl dark:shadow-zinc-900/50 p-8 dark:border dark:border-zinc-800">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Primeiro Acesso</h1>
            <p className="text-gray-500 dark:text-gray-400 mt-1">Crie seu acesso ao portal</p>
          </div>
